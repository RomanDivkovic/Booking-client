...
-- Group members policies (fixed - no infinite recursion)
...
-- Groups policies (fixed - no infinite recursion)
...
-- Group invitations policies (fixed - no infinite recursion)
...
-- Events policies (fixed - no infinite recursion)
